...
fig.savefig('Données0_classées avec variation de parametres.png',bbox_inches='tight', pad_inches=0.1, dpi=300)

df1=pd.DataFrame({'Sigma':sigmas,'Nombre de clusters':Qs,'Nombre moyen de points par cluster':means,
